document.addEventListener("DOMContentLoaded", function(event) {
  ...
  function getLocationWeather(position) {
    ...
    //Possible refactor to address browser geo location requirement of https:// connection.
  ...
  function getData(data) {
    ...
    var displayData = {
      ...
      showClouds: function() {
        var cloudIcon = "'wi wi-night-clear'";
      ...
      toggleMeasurement: function() {
        measurement.addEventListener("mousedown", function() {
          (newMeasurement == tempC) ? newMeasurement = tempF: newMeasurement = tempC;
